...
export default function UploadPage() {
  ...
  // Active mode state: build from scratch
  const [activeMode, setActiveMode] = useState<"upload" | "scratch">("scratch");
  ...
  const handleCreateFromLidarScan = async () => {
    ...
    try {
      ...
      // Save active design ID so 3D Studio loads this project!
      sessionStorage.setItem("homeverse_active_design_id", activeDesignId);
